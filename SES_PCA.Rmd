...
## Asset indices with PCA: A warning
...
Here we do the PCA using the data set that only includes the columns we are interested in and add the first component back to our original data set.
